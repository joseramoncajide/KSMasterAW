...
#combinar
ggplot(mpg, aes(
  x = displ, y = hwy, color = class, shape = factor(cyl)
)) + geom_point()
...
ggplot(mpg, aes(x = manufacturer, y = hwy, fill = class)) + geom_bar(stat =
                                                                       "identity")
...
ggplot(mpg, aes(x = manufacturer, y = hwy, fill = class)) + geom_bar(stat =
                                                                       "identity", position = 'identity') #overlap
...
ggplot(mpg, aes(x = manufacturer)) + geom_bar(aes(fill = class, position =
                                                    'dodge')) + ggtitle('Título')


# coordenadas -------------------------------------------------------------

ggplot(mpg, aes(x = manufacturer)) + geom_bar(aes(fill = class, position =
                                                    'dodge')) + ggtitle('Título') + coord_flip()

ggplot(mpg, aes(x = manufacturer)) + geom_bar(aes(fill = class, position =
                                                    'dodge')) + ggtitle('Título')  + coord_polar()
...
basic + theme_grey()  + theme_minimal() + scale_fill_brewer(palette = "Blues") + theme(
  ...
  text = element_text(
    family = "Arial", colour = "blue", size = 16
  ),
